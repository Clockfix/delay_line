...
#
# Generated by Vivado on Sat Mar 06 23:53:07 EET 2021
...
compile()
{
  ...
  vlogan -work work $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../delay_line.srcs/sources_1/ip/clk_wiz_0_1/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../delay_line.srcs/sources_1/ip/clk_wiz_0_1/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/imants/programs/git/delay_line/vivado_project/delay_line.cache/compile_simlib/vcs"
  fi
