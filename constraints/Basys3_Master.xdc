...
# Designates CARRY4_inst to be placed in SLICE site SLICE_X0Y0
# set_property LOC SLICE_X0Y0 [get_cells CARRY4_inst]

# Preserve the hierarchy of instance CARRY4_inst and FDRE_inst
#set_property KEEP_HIERARCHY TRUE [get_cells CARRY4_inst]
#set_property KEEP_HIERARCHY TRUE [get_cells FDRE_inst0]
...
set_property PACKAGE_PIN M2 [get_ports {o_clock_loopback}]
set_property IOSTANDARD LVCMOS33 [get_ports {o_clock_loopback}]
set_property PACKAGE_PIN N2 [get_ports {i_clock_loopback}]
set_property IOSTANDARD LVCMOS33 [get_ports {i_clock_loopback}]
